...
<div class="contents_title application" >
	<form action="{{route('companys.search')}}" method="post">
		@csrf
		<h3>List Comany</h3>
		<a href="{{route('companys.create') }}" >Tạo</a>
		<div class="">
			<h3>Tìm kiếm ID</h3>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="{{ route('administrators.edit', ['administratorId' => $a->id]) }}" class="btn_S">Chinh sua</a></td>
							</tr>
							@endforeach
						</tbody>
					</table>
