...
class CreateGeneralCommercialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('general_commercials', function (Blueprint $table) {
            $sql = '
                CREATE TABLE IF NOT EXISTS `ass`.`general_commercials` (
                  ...
                  PRIMARY KEY (`id`),
                  INDEX `fk_general_commercials_broadcasters1_idx` (`broadcaster_id` ASC),
                  UNIQUE INDEX `hash_code_UNIQUE` (`key_hash_unique_code`(255) ASC),
                  CONSTRAINT `fk_general_commercials    _broadcasters1`
    ...
    {
        Schema::dropIfExists('general_commercials');
    }
}
