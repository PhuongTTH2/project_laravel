...
class CreateLicenseTargetGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        Schema::table('license_target_groups', function (Blueprint $table) {
            $sql = '
                CREATE TABLE IF NOT EXISTS `ass`.`license_target_groups` (
                  ...
                  PRIMARY KEY (`id`),
                  INDEX `fk_license_target_groups_data_licenses1_idx` (`data_license_id` ASC),
                  CONSTRAINT `fk_license_target_groups_data_licenses1`
