...
class CreateGeneralRatingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('general_ratings', function (Blueprint $table) {
            $sql = "
                CREATE TABLE `general_ratings` (
                  ...
                  PRIMARY KEY (`id`),
                  KEY `index_general_ratings_001` (`key_hash_code`(255),`data_type_id`,`rate_type_id`,`aggregate_type_id`,`target_code`,`period_from_date`,`period_to_date`),
                  KEY `index_general_ratings_002` (`data_type_id`,`aggregate_type_id`,`target_code`,`period_type_id`,`period_from_date`,`period_to_date`)
                ) ENGINE=InnoDB";
