 ...
 * 
// ======= Call the function on your HTML form and trigger a function when the form gets 'Dirty' =======
$("#form").dirty({
  onDirty: function(){
    alert("Dirty");
  }
...
// ======= Trigger a function when the form gets 'Clean' =======
$("#form").dirty({
  onClean: function(){
    alert("Clean");
  }
...
// ======= Prevent the user from navigating away when there are unsaved changes on the page =======
$("#form").dirty({
  preventLeaving: true
});
...
(function($) {
    ...
    Dirty.prototype = {
        ...
        checkValues: function(e) {
            ...
            if (e) {
//                e.stopImmediatePropagation(); // nthaih, comment vi input file ko chay dc
            }
        },
